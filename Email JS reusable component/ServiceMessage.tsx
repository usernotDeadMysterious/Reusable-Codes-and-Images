...
// Replace Id's 
    ...
    try {
      // Auto-reply to user
      await emailjs.sendForm(serviceID, 'template_id', formRef.current, userID);
      // template id of User email template 

      // Notify yourself
      await emailjs.sendForm(serviceID, 'template_id', formRef.current, userID);
      // template id of template to your self remove if u dont want to use it
